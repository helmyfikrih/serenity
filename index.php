              ...
              <ul class="nav topnav">
                ...
                ?>
                  ...
                  <li <?php if ($mnu == "tenant") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=tenant'><i class="icon-star"></i>Pelaku Usaha</a></li>
                ...
                ?>
                  ...
                  <li <?php if ($mnu == "abberita") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=abberita'><i class="icon-book"></i>Berita</a></li>
                  ...
                  <li <?php if ($mnu == "abgallery") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=abgallery'><i class="icon-picture"></i>Produk</a></li>
                  <li <?php if ($mnu == "abtenant") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=abtenant'><i class="icon-user"></i>Pelaku Usaha</a></li>
                  <li <?php if ($mnu == "peta") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=peta'><i class="icon-flag"></i>Peta</a></li>
                ...
                ?>
                  ...
                  <li <?php if ($mnu == "puberita" || $mnu == "puberitadetail") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=puberita'><i class="icon-book"></i>Berita</a></li>
                  <li <?php if ($mnu == "puseminar" || $mnu == "puseminardetail") {
                        echo "class='active'";
                ...
                ?>
                  ...
                  <li <?php if ($mnu == "guberita" || $mnu == "guberitadetail") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=guberita'><i class="icon-book"></i>Berita</a></li>
                  <li <?php if ($mnu == "guseminar" || $mnu == "guseminardetail") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=guseminar'><i class="icon-calendar"></i>Kegiatan</a></li>
                  <li <?php if ($mnu == "peta") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=peta'><i class="icon-flag"></i>Peta</a></li>
                  <li <?php if ($mnu == "gugallery" || $mnu == "galeridetail") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=gugallery'><i class="icon-picture"></i>Galeri</a></li>
                  <li <?php if ($mnu == "gutentang") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=gutentang'><i class="icon-home"></i>Tentang Kami</a></li>
                  <li <?php if ($mnu == "daftar") {
                        echo "class='active'";
                      } ?>><a href='index.php?mnu=daftar'><i class="icon-plus"></i>Buat Akun</a></li>
                  <li <?php if ($mnu == "login") {
                        echo "class='active'";
            ...
            <div class="span12">
              <div class="centered">
                <?php if ($mnu == "user") {
                  ...
                  $tittle = "Berita";
                } elseif ($mnu == "guberita" || $mnu == "guberitadetail") {
                  $tittle = "Berita";
                } elseif ($mnu == "puseminar" || $mnu == "puseminardetail") {
                  $tittle = "Kegiatan";
                } elseif ($mnu == "guseminar" || $mnu == "guseminardetail") {
                  $tittle = "Kegiatan";
                } elseif ($mnu == "abuser") {
                  $tittle = "Profil Admin";
                ...
                <?php if ($mnu == "login") {
                  ...
                  $desc = "Anda dapat menghubungi kami melalui kontak di bawah ini";
                } elseif ($mnu == "tenant") {
                  $desc = "Anda dapat mengunduh data pelaku usaha dengan mengklik icon print";
                } elseif ($mnu == "peserta") {
                  $desc = "Anda dapat mengunduh data peserta dengan mengklik icon print";
                } else {
  ...
  <section id="maincontent">
    <div class="container">
      ...
      if ($mnu == "admin") {
        ...
        require_once "berita/berita.php";
      } else if ($mnu == "abuser") {
        require_once "user/abuser.php";
      } // Edit sesuai profil user admin bidang tersebut untuk ganti password atau ubah profilnya
      else if ($mnu == "abtenant") {
        require_once "tenant/abtenant.php";
      } // Edit data pelaku usaha sesuai tabel tenant bidang tertentu
      else if ($mnu == "abberita") {
        require_once "berita/abberita.php";
      } // Nanti berita yang tampil sesuai bidangnya masing-masing
      else if ($mnu == "abseminar") {
        require_once "seminar/abseminar.php";
      } // Nanti seminar yang tampil sesuai bidangnya masing-masing
      else if ($mnu == "abgallery") {
        require_once "gallery/abgallery.php";
      } // Nanti gallery yang tampil sesuai bidangnya masing-masing
      else if ($mnu == "abpeserta") {
        require_once "peserta/abpeserta.php";
      } // Nanti peserta yang tampil sesuai bidangnya masing-masing dan berdasarkan id_tenant dan id_seminar

      else if ($mnu == "tenant") {
        require_once "tenant/tenant.php";
      } else if ($mnu == "putenant") {
        require_once "tenant/putenant.php";
      } else if ($mnu == "putenantupdate") {
        require_once "tenant/putenantupdate.php";
      } else if ($mnu == "putenantadd") {
        require_once "tenant/putenantadd.php";
      } else if ($mnu == "gantipasswordpu") {
        require_once "user/gantipasswordpu.php";
      } else if ($mnu == "gantipasswordab") {
        require_once "user/gantipasswordab.php";
      } else if ($mnu == "pugallery") {
        require_once "gallery/pugallery.php";
      } else if ($mnu == "puberita") {
        require_once "berita/puberita.php";
      } // Belom Diedit File Codingnya + Database nya masih konek ke seminar
      else if ($mnu == "puberitadetail") {
        require_once "berita/puberitadetail.php";
      } else if ($mnu == "guberitadetail") {
        require_once "berita/guberitadetail.php";
      } else if ($mnu == "puseminar") {
        require_once "seminar/puseminar.php";
      } else if ($mnu == "profiltenant") {
        require_once "tenant/profiltenant.php";
      } else if ($mnu == "seminar") {
        require_once "seminar/seminar.php";
      } else if ($mnu == "guseminar") {
        require_once "seminar/guseminar.php";
      } else if ($mnu == "guseminardetail") {
        require_once "seminar/guseminardetail.php";
      } else if ($mnu == "puseminardetail") {
        require_once "seminar/puseminardetail.php";
      } else if ($mnu == "guberita") {
        require_once "berita/guberita.php";
      } // Belom Diedit File Codingnya + Database nya masih konek ke seminar
      ...
      } else if ($mnu == "direction") {
        require_once "tesdir.php";
      } else if ($mnu == "gugallery") {
        require_once "gallery/gugallery.php";
      } else if ($mnu == "gutentang") {
        require_once "gutentang.php";
      } else if ($mnu == "galeridetail") {
        require_once "gallery/galeridetail.php";
      } else if ($mnu == "logout") {
