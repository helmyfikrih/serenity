...
<td width="9">:
<td colspan="2"><b><?php echo $id_user;?></b></tr>
<tr>
<td><label for="nama_user">Nama User</label>
<td>:<td width="213"><input name="nama_user" type="text" id="nama_user" value="<?php echo $nama_user;?>" size="20" />
</td>
...
<option value="Super Admin" <?php if($kategori=="Super Admin"){echo"selected";}?>>Super Admin</option>
<option value="Admin Bidang Koperasi dan UKM" <?php if($kategori=="Admin Bidang Koperasi dan UKM"){echo"selected";}?>>Admin Bidang Koperasi dan UKM</option>
<option value="Admin Bidang Perdagangan" <?php if($kategori=="Admin Bidang Perdagangan"){echo"selected";}?>>Admin Bidang Perdagangan</option>
<option value="Admin Bidang Perindustrian" <?php if($kategori=="Admin Bidang Perindustrian"){echo"selected";}?>>Admin Bidang Perindustrian</option>
...
<?php  
  $sqlq="select distinct(kategori) from `$tbuser` order by `id_user` desc";
...
$hapus=process($conn,$sql);
	if($hapus) {echo "<script>alert('Data $id_user berhasil dihapus !');document.location.href='?mnu=user';</script>";}
	else{echo"<script>alert('Data $id_user gagal dihapus...');document.location.href='?mnu=user';</script>";}
}
?>
