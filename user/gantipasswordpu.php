...
<form action="" method="post" enctype="multipart/form-data">
	<table width="40%">
		...
		<tr>
			...
			<td>:
			<td><input name="password1" type="text" id="password" value="<?php echo $password; ?>" size="25" />
			</td>
		</tr>
		...
		<tr>
			...
			<td>:
			<td><input name="password3" type="text" id="password" value="<?php echo $password; ?>" size="25" />
			</td>
		</tr>
		<tr>
			<td>
...
if (isset($_POST["Simpan"])) {
	...
	if ($jums > 0) {
		...
		echo "<script>alert('Password Lama Salah');document.location.href='?mnu=gantipasswordpu';</script>";
	}
	...
	if ($password2 == $password3) {
		...
		echo "<script>alert('Konfrimasi Password Baru Tidak Sesuai');document.location.href='?mnu=gantipasswordpu';</script>";
	}
