...
<?php  
  $sql="select * from `$tbseminar` order by `id_seminar` desc";							
		...
		<!-- start article 1 -->
          <article class="blog-post">
            <div class="post-heading">
              <h3><a href="#"><?php echo $nama_seminar;?> </a></h3>
            </div>
            <div class="row">
              <div class="span3">
              ...
              <div class="span5">
                ...
                <a href="index.php?mnu=guseminardetail&kd=<?php echo $id_seminar;?>">
					<button class="btn" type="button">Detail Seminar</button>
				</a>
              </div>
            </div>
          </article>
