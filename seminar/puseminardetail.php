          ...
          <div class="project-widget">
            ...
            <form method="post">
              ...
              <ul class="project-detail">
                ...
                <li>
                  <input onclick="return confirm('Yakin Mendaftar Kegiatan Ini?')" name="Simpan" type="submit" id="Simpan" class="btn btn-primary" value="Daftar" />
            ...
            <a href="index.php?mnu=puseminar"><button class="btn">Kembali</button></a>
          </div>
        </div>
      </div>
    </article>
...
'$keterangan'
    ...
    if ($simpan) {
      echo "<script>alert('Peserta $id_peserta berhasil Mendaftar !');document.location.href='?mnu=puseminardetail&kd=$id_seminar';</script>";
    } else {
      echo "<script>alert('Data $id_peserta gagal disimpan...');document.location.href='?mnu=puseminardetail&kd=$id_seminar';</script>";
    }
  }
}
?>