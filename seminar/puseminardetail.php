...
$simpan=process($conn,$sql);
	if($simpan) {echo "<script>alert('Peserta $id_peserta berhasil Mendaftar !');document.location.href='?mnu=puseminardetail&kd=$id_seminar';</script>";}
else{echo"<script>alert('Data $id_peserta gagal disimpan...');document.location.href='?mnu=puseminardetail&kd=$id_seminar';</script>";}
}
}
?>