		...
		<form action="" method="post" enctype="multipart/form-data">
			<table width="40%">
				<tr>
					...
					<td width="9">:
					<td colspan="2"><b><?php echo $id_seminar; ?></b>
				</tr>
				<tr>
					<td><label for="nama_seminar">Judul</label>
					<td>:
					<td width="213"><input name="nama_seminar" type="text" id="nama_seminar" value="<?php echo $nama_seminar; ?>" size="20" required />
					</td>
...
";
				...
				<tr>
					...
					<td colspan="2">
						...
						=> <a href='#' onclick='buka("admin/zoom.php?id=<?php echo $id_seminar; ?>")'><?php echo $gambar0; ?></a>
					</td>
				</tr>
...
onClick='return confirm(\"Apakah Anda Yakin Akan Menghapus Kegiatan $nama_seminar?\")'></i> </a></div></td>
		...
		if ($jmldata > 0) {
			...
			for ($i = 1; $i <= $jmlhal; $i++)
				if ($i != $page) {
					echo "<a href='$_SERVER[PHP_SELF]?page=$i&mnu=abseminar'>$i</a> ";
				} else {
