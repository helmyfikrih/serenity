...
$simpan=process($conn,$sql);
	if($simpan) {echo "<script>alert('Data $id_tenant berhasil disimpan !');document.location.href='?mnu=putenant';</script>";}
		else{echo"<script>alert('Data $id_tenant gagal disimpan...');document.location.href='?mnu=putenantadd';</script>";}
