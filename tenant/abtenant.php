...
<td width="10">:
<td colspan="2"><b><?php echo $id_tenant;?></b></tr>
...
<option value="Pilih" >Pilih Kategori</option>
 <?php
	...
	echo"<option value='$kategori0' ";if($kategori0==$kategori){echo"selected";} echo">$kategori0</option>";
	?>
</select>
</td>
</tr>
...
if($jmldata>0){
	...
	for($i=1;$i<=$jmlhal;$i++)
	if ($i != $page){echo "<a href='$_SERVER[PHP_SELF]?page=$i&mnu=abtenant'>$i</a> ";}
...
$simpan=process($conn,$sql);
	if($simpan) {echo "<script>alert('Data $id_tenant berhasil disimpan !');document.location.href='?mnu=abtenant';</script>";}
		else{echo"<script>alert('Data $id_tenant gagal disimpan...');document.location.href='?mnu=abtenant';</script>";}
	}
	else{
	...
	$ubah=process($conn,$sql);
		if($ubah) {echo "<script>alert('Data $id_tenant berhasil diubah !');document.location.href='?mnu=abtenant';</script>";}
		else{echo"<script>alert('Data $id_tenant gagal diubah...');document.location.href='?mnu=abtenant';</script>";}
	}//else simpan
}
?>
...
$hapus=process($conn,$sql);
	if($hapus) {echo "<script>alert('Data $id_tenant berhasil dihapus !');document.location.href='?mnu=abtenant';</script>";}
	else{echo"<script>alert('Data $id_tenant gagal dihapus...');document.location.href='?mnu=abtenant';</script>";}
}
?>
