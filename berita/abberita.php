...
if($jmldata>0){
	...
	for($i=1;$i<=$jmlhal;$i++)
	if ($i != $page){echo "<a href='$_SERVER[PHP_SELF]?page=$i&mnu=abberita'>$i</a> ";}
...
$simpan=process($conn,$sql);
	if($simpan) {echo "<script>alert('Data $id_berita berhasil disimpan !');document.location.href='?mnu=abberita';</script>";}
		else{echo"<script>alert('Data $id_berita gagal disimpan...');document.location.href='?mnu=abberita';</script>";}
	}
	else{
	...
	$ubah=process($conn,$sql);
		if($ubah) {echo "<script>alert('Data $id_berita berhasil diubah !');document.location.href='?mnu=abberita';</script>";}
		else{echo"<script>alert('Data $id_berita gagal diubah...');document.location.href='?mnu=abberita';</script>";}
	}//else simpan
}
?>
...
$hapus=process($conn,$sql);
	if($hapus) {echo "<script>alert('Data $id_berita berhasil dihapus !');document.location.href='?mnu=abberita';</script>";}
	else{echo"<script>alert('Data $id_berita gagal dihapus...');document.location.href='?mnu=abberita';</script>";}
}
?>
