...
echo"<tr>
				...
				<td><div align='center'>
<a href='?mnu=peserta&pro=ubah&kode=$id_peserta'><i class='icon-pencil'></i></a>
<a href='?mnu=peserta&pro=hapus&kode=$id_peserta'><i class='icon-trash' alt='hapus' 
...
$hapus=process($conn,$sql);
	if($hapus) {echo "<script>alert('Data $id_peserta berhasil dihapus !');document.location.href='?mnu=peserta';</script>";}
	else{echo"<script>alert('Data $id_peserta gagal dihapus...');document.location.href='?mnu=peserta';</script>";}
}
?>
